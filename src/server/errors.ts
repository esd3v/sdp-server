...
const HTTPError500: HTTPError = (ctx, params) => HTTPError(ctx, {
  ...params,
  status: 500,
});

export const pageIsNaN = (ctx: any) => HTTPError500(ctx, {
  code: 1,
  title: 'Page is not a number',
});

export const noSuchPage = (ctx: any) => HTTPError500(ctx, {
  code: 2,
  title: 'No such page',
});

export const invalidPage = (ctx: any) => HTTPError500(ctx, {
  code: 3,
  title: `Couldn't parse the page`,
});

export const incorrectPerPage = (ctx: any) => HTTPError500(ctx, {
  code: 4,
